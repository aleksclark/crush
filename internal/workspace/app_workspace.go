...
// PluginApp returns the plugin app from the agent coordinator, if available.
func (w *AppWorkspace) PluginApp() *plugin.App {
	if w.app.AgentCoordinator != nil {
		return w.app.AgentCoordinator.PluginApp()
	}
	return nil
}
