...
type ProviderConfig struct {
	...
	Type catwalk.Type `json:"type,omitempty" jsonschema:"description=Provider type that determines the API format,enum=openai,enum=openai-compat,enum=openai-extended,enum=anthropic,enum=gemini,enum=azure,enum=vertexai,enum=bedrock,enum=openrouter,enum=hyper,default=openai"`
