...
// LargeMCPContentThreshold is 3x the max of fetch, 5x the max of bash because
// it should be assumed that a large MCP style request was made on purpose.
const LargeMCPContentThreshold = 150000 // 150KB

// mcpMaxOutputLength is the max output length for MCP tools, can be overridden
// by setting CRUSH_MCP_MAX_OUTPUT.
